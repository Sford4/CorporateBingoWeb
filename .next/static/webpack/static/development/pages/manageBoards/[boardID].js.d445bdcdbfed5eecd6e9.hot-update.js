...
var BoardBuilder = function BoardBuilder(props) {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, board.rewards.length && board.rewards[board.rewards.length - 1].position.includes('wholeBoard') ? generateWholeBoardRewardIcon(board.rewards[0]) : null, __jsx(_BoardBuilderBoard__WEBPACK_IMPORTED_MODULE_4__["default"], {
    board: board,
...
//# sourceMappingURL=[boardID].js.d445bdcdbfed5eecd6e9.hot-update.js.map