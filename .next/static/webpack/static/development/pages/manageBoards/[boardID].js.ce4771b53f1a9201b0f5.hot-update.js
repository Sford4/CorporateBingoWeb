...
var BoardBuilder = function BoardBuilder(props) {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, console.log(board.rewards[board.rewards.length - 1]), board.rewards.length && board.rewards[0].position.includes('wholeBoard') ? generateWholeBoardRewardIcon(board.rewards[0]) : null, __jsx(_BoardBuilderBoard__WEBPACK_IMPORTED_MODULE_4__["default"], {
    board: board,
...
//# sourceMappingURL=[boardID].js.ce4771b53f1a9201b0f5.hot-update.js.map