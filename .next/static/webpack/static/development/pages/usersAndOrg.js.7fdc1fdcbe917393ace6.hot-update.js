...
var UsersDetails = function UsersDetails(props) {
  ...
  var updateUsers = function updateUsers(type, user) {
    if (type === 'delete') {
      ...
      contextSetUsers(Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, contextOrg, {
        users: _users
      }));
    } else if (type === 'edit') {
      console.log('updating user', user);
      contextSetUsers(Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, contextOrg, {
        users: contextOrgUsers.map(function (oldUser) {
...
//# sourceMappingURL=usersAndOrg.js.7fdc1fdcbe917393ace6.hot-update.js.map