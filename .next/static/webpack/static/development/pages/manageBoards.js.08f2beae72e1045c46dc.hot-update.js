...
var ManageBoardsHome = function ManageBoardsHome(props) {
  ...
  var generateBoardRows = function generateBoardRows() {
    ...
    if (rows.length) {
      return stableSort(rows, getSorting(order, orderBy)).slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(function (board, index) {
...
//# sourceMappingURL=manageBoards.js.08f2beae72e1045c46dc.hot-update.js.map